...
$register_client->setRequestClientName("Vlad Karapetyan");
$register_client->setRequestResponseTypes("code");
$register_client->setRequestAppType("web");
$register_client->setRequestGrantTypes("authorization_code");
$register_client->setRequestContacts("vlad.karapetyan.1988@mail.ru");
$register_client->setRequestJwksUri(Oxd_config::$gluuServerUrl."/jwks");
...
echo '<br/>ClientIdIssuedAt: '.gmdate("Y-m-d\TH:i:s\Z", $register_client->getResponseClientIdIssuedAt());
...
$get_user_info->setRequestOxdId("06538062-4800-4737-89d3-b0599bd02ea1");
$get_user_info->setRequestAccessToken($authorization_code_flow->getResponseAccessToken());

$get_user_info->request();

echo '<br/>Get_user_info<pre>';
