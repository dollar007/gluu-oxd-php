...
$client->setRequestDiscoveryUrl("https://ce-dev.gluu.org/.well-known/openid-configuration");
$client->setRequestUmaDiscoveryUrl("http://ce-dev.gluu.org/.well-known/uma-configuration");
